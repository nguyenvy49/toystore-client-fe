  ...
  return (
    <>
      ...
      {!myAccount ? (
        ...
        <section className="overflow-hidden py-12 sm:py-16 bg-slate-50">
          <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
            <div className="flex flex-col xl:flex-row gap-7.5">
              {/* <!--== user dashboard menu start ==--> */}
              <div className="xl:max-w-[340px] w-full bg-white rounded-2xl border border-slate-200/80 shadow-sm self-start">
                <div className="flex xl:flex-col">
                  <div className="hidden lg:flex flex-wrap items-center gap-4 py-5 px-6 border-r xl:border-r-0 xl:border-b border-slate-100">
                    <div className="w-12 h-12 rounded-full bg-indigo-100 text-indigo-600 font-extrabold text-lg flex items-center justify-center border border-indigo-200">
                      {myAccount.fullName ? myAccount.fullName.charAt(0).toUpperCase() : "U"}
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500">{myAccount.email}</p>
                    </div>
                  </div>

                  <div className="p-4 sm:p-5">
                    <div className="flex flex-wrap xl:flex-nowrap xl:flex-col gap-2">
                      <button
                        onClick={() => setActiveTab("orders")}
                        className={`flex items-center rounded-xl gap-3 py-3 px-4 font-semibold text-xs ease-out duration-200 ${activeTab === "orders"
                          ? "text-white bg-slate-900 shadow-sm"
                          : "text-slate-700 bg-slate-100/70 hover:bg-slate-200/80"
                          }`}
                      >
                        <svg
                      ...
                      <button
                        ...
                        className={`flex items-center rounded-xl gap-3 py-3 px-4 font-semibold text-xs ease-out duration-200 ${activeTab === "account-details"
                          ? "text-white bg-slate-900 shadow-sm"
                          : "text-slate-700 bg-slate-100/70 hover:bg-slate-200/80"
                          }`}
                      >
              ...
              <div
                className={`flex-1 w-full bg-white rounded-2xl border border-slate-200/80 shadow-sm p-6 sm:p-8 ${activeTab === "orders" ? "block" : "hidden"
                  }`}
              >
                <Orders />
              </div>
              ...
              <div
                className={`flex-1 w-full ${activeTab === "account-details" ? "block" : "hidden"
                  }`}
              >
                {/* FORM 1: Cập nhật thông tin cá nhân */}
                <form onSubmit={handleSubmitProfile}>
                  <div className="bg-white border border-slate-200/80 shadow-sm rounded-2xl p-6 sm:p-8 mb-6">
                    <h3 className="font-extrabold text-lg text-slate-900 mb-5 pb-3 border-b border-slate-100">
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <input
                          ...
                          className="rounded-xl border border-slate-200 bg-slate-50/50 text-slate-900 text-xs sm:text-sm w-full py-2.5 px-4 outline-none transition-all focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-500/20"
                        />
                      </div>
                    ...
                    <button
                      type="submit"
                      className="inline-flex font-bold text-xs text-white bg-slate-900 hover:bg-indigo-600 py-3 px-6 rounded-xl transition-colors shadow-sm mt-6"
                    >
                      Lưu thông tin
                    </button>
                  </div>
                ...
                <form onSubmit={handleSubmitPassword}>
                  <div className="bg-white border border-slate-200/80 shadow-sm rounded-2xl p-6 sm:p-8">
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        <label htmlFor="confirmNewPassword" className="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-2">
